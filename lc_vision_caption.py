...
DEFAULT_SYSTEM_PROMPT = (
    "You are a helpful vision assistant. Describe what you are shown clearly and "
    "concisely. Respond with the final answer only -- no reasoning, no <think> blocks."
)
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "prompt": (
                    "STRING",
                    {"multiline": True, "default": "Describe this image.", "tooltip": "The user instruction. Reference labels are added automatically for whatever's connected."},
                ),
            },
            "optional": {
